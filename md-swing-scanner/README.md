...
**`research_archive/`** (2026-09-17) — 64 one-off research scripts, moved here to declutter
the main folder. Not deleted — each is the reproducible record behind a specific
`FINDINGS.md` claim. Needs `PYTHONPATH=.` to re-run (see its own README). A handful of
scripts still in active use stay in the main folder rather than here.
